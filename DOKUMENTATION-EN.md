...
3. Scripts:            Copy to /usr/local/sbin/, chmod 700, back up existing versions
4. SMTP configuration: Interactive input → /etc/nextcloud-update/smtp.conf (chmod 600)
5. Cron job:           Optional, schedule configurable
```
